...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        ViewHolder(View itemview){
            ...
            carnet = (TextView)  itemview.findViewById(R.id.cant_estudiantes);
            eliminar = (ImageButton) itemview.findViewById(R.id.imageButton);
        }
        ...
        public class eventoBorrar  implements View.OnClickListener{
            ...
            public void onClick(View view) {
               ...
               //AuxiliarStudents instancia = new Estudiantes(context)
                ...
                alerta.setMessage("Esta seguro que desea Eliminar: " + student.getIdStudent());
